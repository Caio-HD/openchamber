...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.voice.page.localTts.availableToDownload': '다운로드 가능',
  'settings.voice.page.localTts.filterPlaceholder': '언어 또는 설명으로 필터링',
  'settings.voice.page.localTts.filterNoMatch': '필터와 일치하는 모델이 없습니다',
