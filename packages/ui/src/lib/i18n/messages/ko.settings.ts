...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.section.updates': '업데이트',
  'settings.openchamber.visual.field.updateChannel': '업데이트 채널',
  'settings.openchamber.visual.field.updateChannelHint': '정식 릴리스는 Stable, 사전 릴리스 빌드는 Beta를 선택하세요',
  'settings.openchamber.visual.toast.switchedChannel': '업데이트 채널이 {channel}(으)로 변경되었습니다.',
  'settings.openchamber.visual.toast.latestVersionForChannel': '{channel} 채널의 최신 버전을 사용 중입니다.',
