...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.voice.page.localTts.availableToDownload": "Disponibles para descargar",
  "settings.voice.page.localTts.filterPlaceholder": "Filtrar por idioma o descripción",
  "settings.voice.page.localTts.filterNoMatch": "Ningún modelo coincide con el filtro",
