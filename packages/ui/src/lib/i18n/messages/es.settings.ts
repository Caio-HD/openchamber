...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.section.updates": "Actualizaciones",
  "settings.openchamber.visual.field.updateChannel": "Canal de actualización",
  "settings.openchamber.visual.field.updateChannelHint": "Elija Stable para versiones oficiales o Beta para versiones preliminares",
  "settings.openchamber.visual.toast.switchedChannel": "Canal de actualización cambiado a {channel}.",
  "settings.openchamber.visual.toast.latestVersionForChannel": "Estás usando la última versión para el canal {channel}.",
