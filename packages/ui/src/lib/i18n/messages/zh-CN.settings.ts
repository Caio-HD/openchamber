...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.voice.page.localTts.availableToDownload': '可下载',
  'settings.voice.page.localTts.filterPlaceholder': '按语言或描述筛选',
  'settings.voice.page.localTts.filterNoMatch': '没有模型与筛选条件匹配',
