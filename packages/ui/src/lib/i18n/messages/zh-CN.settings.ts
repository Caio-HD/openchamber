...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.updateChannelHint': '选择 Stable 获取官方发布版本，选择 Beta 获取预发布版本',
  'settings.openchamber.visual.toast.switchedChannel': '更新通道已切换为 {channel}。',
