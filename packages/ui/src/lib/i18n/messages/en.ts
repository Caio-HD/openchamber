...
export const dict = {
  ...
  ...settingsDict,
  'gitView.operation.title': 'Git operation',
  'gitView.operation.recovery.storage': 'Git recovery storage is unavailable. Restore browser storage and refresh. New mutations are blocked.',
  'gitView.operation.recovery.capacity': 'Git recovery storage is full. Resolve saved operations before starting another.',
  'gitView.operation.recovery.reconciling': 'Checking saved Git operation references…',
  'gitView.operation.recovery.repository': 'The repository could not be verified. Refresh before starting another Git operation.',
  'gitView.operation.recovery.inspect': 'If the server no longer knows this ID, inspect the local repository and remote outside OpenChamber. The saved reference remains blocked; missing status never authorizes a repeated transfer.',
  'gitView.operation.localCommit': 'The local commit was created and is retained.',
  'gitView.operation.unknownHint': 'The outcome is unknown. Refresh this operation before starting another transfer. Nothing will be replayed automatically.',
  'gitView.operation.refresh': 'Refresh operation',
  'gitView.operation.cancel': 'Cancel operation',
  'gitView.operation.state.unavailable': 'Operation status unavailable',
  'gitView.operation.state.planned': 'Planned',
  'gitView.operation.state.running': 'Running',
  'gitView.operation.state.succeeded': 'Succeeded',
  'gitView.operation.state.partial': 'Partially completed',
  'gitView.operation.state.failed': 'Failed',
  'gitView.operation.state.cancelled': 'Cancelled',
  'gitView.operation.state.outcome-unknown': 'Outcome unknown',
  'gitView.operation.state.conflicted': 'Conflict',
  'gitView.operation.state.skipped': 'Skipped',
  'gitView.operation.completed.validated': 'Repository and target validated',
  'gitView.operation.completed.authenticated': 'Authentication completed',
  'gitView.operation.completed.transferred': 'Transfer completed',
  'gitView.operation.completed.updated-local-repository': 'Local repository updated',
  'gitView.operation.completed.checked-out': 'Checkout completed',
  'gitView.operation.completed.cleaned-up': 'Cleanup completed',
  'gitView.remotes.title': 'Other remotes',
  'gitView.remotes.description': 'Addresses this repository has beside the one its identity was applied to. Until one is granted, OpenChamber neither fetches from it nor pushes to it.',
  'gitView.remotes.grant': 'Answer as {identity}',
  'gitView.hydration.title': 'Checkout hydration',
  'gitView.hydration.description': 'Initialize submodules and fetch Git LFS content with separate authorization for each endpoint.',
  ...
  'gitView.hydration.kind.submodule': 'Submodule',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Completed',
  'gitView.hydration.status.failed': 'Failed',
  'gitView.hydration.status.cancelled': 'Cancelled',
  'gitView.hydration.status.authorization-required': 'Authorization required',
  'gitView.hydration.status.invalid': 'Invalid configuration',
  'gitView.hydration.status.client-missing': 'Client missing',
  'gitView.hydration.status.not-needed': 'Not needed',
  'gitView.publish.title': 'Publish',
  'gitView.publish.commitKept': 'The local commit was created and has been kept. Publication did not complete successfully.',
  'gitView.publish.syncTitle': 'Choose sync targets',
  'gitView.publish.description': 'Publish {branch} to an exact Git destination. Provider accounts do not select the destination.',
  'gitView.publish.fetchSource': 'Fetch source remote',
  'gitView.publish.sourceBranch': 'Source branch',
  'gitView.publish.fetchFirst': 'No cached branches for this remote. Cancel and use Fetch first.',
  'gitView.publish.pushDestination': 'Push destination remote',
  'gitView.publish.selectRemote': 'Select a bound remote',
  'gitView.publish.destinationBranch': 'Destination branch',
  'gitView.publish.noGrants': 'Configure a Git transport binding before publishing.',
  'gitView.publish.contributorCommitFirst': 'This contributor worktree requires destination approval after the commit. Continue? Cancelling publication later will keep the local commit.',
  'gitView.publish.detached': 'Publishing detached HEAD is unsupported. Check out a local branch first.',
  'gitView.publish.stale': 'The branch or Git authority changed. Nothing was retried. Choose the target again.',
  'gitView.publish.cancelled': 'Publication cancelled. No Git transfer started.',
  'gitView.publish.succeeded': 'Published to the selected destination',
  ...
  'chat.shellBoundary.status': 'Unverified · outside managed boundary',
  'chat.shellBoundary.agentAria': 'Agent shell execution is unverified and outside the managed Git boundary',
  'chat.shellBoundary.userAria': 'User shell execution is unverified and outside the managed Git boundary',
  ...
  'gitView.context.description': 'What one identity does not settle on its own: the agent shell, the repository\u2019s other addresses, and the separate grants submodules and Git LFS need. Identities are managed in Git Settings.',
  ...
  'gitView.identity.unavailableScheme': 'Needs an {scheme} remote',
  ...
  'worktree.bootstrap.toast.authorizationRequired': 'Authorize the checkout repository and its submodules, then retry.',
  ...
  'gitView.pr.actions.openOnProvider': 'Open on {provider}',
  'gitView.pr.actions.openOnProviderAria': 'Open pull request on {provider}',
  ...
  'gitView.pr.providerNotConnected': '{provider} is not connected',
  ...
  'gitView.pr.capabilitiesUnavailable': 'Unable to load provider capabilities',
  ...
  'gitView.contributor.chooseDestination': 'Select the exact destination for this contributor branch.',
  'gitView.contributor.destination.contributor-fork': 'Contributor fork',
  'gitView.contributor.destination.own-fork': 'Your fork',
  'gitView.contributor.destination.bound-repository': 'Bound repository',
  'gitView.contributor.destination.other': 'Other remote',
  'gitView.toast.contributorPublishCancelled': 'Publishing was cancelled. No remote was changed.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'Changes were updated locally, but publishing was cancelled.',
  'gitView.toast.unstageFileFailed': 'Failed to unstage changes',
  'gitView.confirm.systemTransport': 'System Git may use credentials configured on this machine. Continue with this Git operation?',
  ...
  'session.changeRequestPicker.error.noProvider': 'No supported source control remote was found',
  'session.changeRequestPicker.title': 'Link change request',
  'session.changeRequestPicker.description': 'Select a pull request or merge request to attach review context to this message.',
  'session.changeRequestPicker.searchPlaceholder': 'Search by title or number, or paste a change request URL',
  'session.changeRequestPicker.includeDiffAria': 'Include the change request diff in the attached context',
  'session.changeRequestPicker.includeDiff': 'Include diff',
  'session.changeRequestPicker.loading.changeRequests': 'Loading change requests...',
  'session.changeRequestPicker.actions.useChangeRequest': 'Use change request {reference}',
  'session.changeRequestPicker.empty.noneFound': 'No change requests found',
  'session.changeRequestPicker.empty.noneOpen': 'No open change requests found',
  'session.issuePicker.title': 'Link issue',
  'session.issuePicker.description': 'Select an issue to attach its context to this message.',
  'session.issuePicker.searchPlaceholder': 'Search by title or number, or paste an issue URL',
  'session.issuePicker.loading.issues': 'Loading issues...',
  'session.issuePicker.actions.useIssue': 'Use issue #{number}',
  'session.issuePicker.empty.noneFound': 'No issues found',
  'session.issuePicker.empty.noneOpen': 'No open issues found',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'The change request authority is no longer available. Select it again.',
  'session.newWorktree.trust.confirmation': 'This checkout contains executable actions:\n\n{actions}\n\nRun them now? Cancel leaves the checkout Git-ready without running them.',
