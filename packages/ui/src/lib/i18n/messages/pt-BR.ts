...
export const dict: Record<I18nKey, string> = {
  ...
  ...settingsDict,
  'gitView.context.configure': 'Configurar repositório',
  'gitView.context.description': 'O que uma identidade não resolve sozinha: o shell do agente, os outros endereços do repositório e as permissões separadas de que submódulos e Git LFS precisam. As identidades são gerenciadas nas configurações do Git.',
  ...
  'gitView.identity.configChanged': 'A configuração do Git do repositório mudou depois que esta identidade foi aplicada. Escolha a identidade de novo para atualizá-la.',
  ...
  'gitView.identity.unavailableScheme': 'Precisa de um remoto {scheme}',
  'gitView.context.settings': 'Abrir configurações do Git',
  'gitView.operation.title': 'Operação do Git',
  'gitView.operation.recovery.storage': 'O armazenamento de recuperação do Git está indisponível. Restaure o armazenamento do navegador e atualize. Novas alterações estão bloqueadas.',
  'gitView.operation.recovery.capacity': 'O armazenamento de recuperação do Git está cheio. Resolva as operações salvas antes de iniciar outra.',
  'gitView.operation.recovery.reconciling': 'Verificando referências de operações do Git salvas…',
  'gitView.operation.recovery.repository': 'Não foi possível verificar o repositório. Atualize antes de iniciar outra operação do Git.',
  'gitView.operation.recovery.inspect': 'Se o servidor não reconhecer mais este ID, inspecione o repositório local e o remoto fora do OpenChamber. A referência salva permanece bloqueada; a ausência de status nunca autoriza repetir uma transferência.',
  'gitView.operation.localCommit': 'O commit local foi criado e está preservado.',
  'gitView.operation.unknownHint': 'O resultado é desconhecido. Atualize esta operação antes de iniciar outra transferência. Nada será repetido automaticamente.',
  'gitView.operation.refresh': 'Atualizar operação',
  'gitView.operation.cancel': 'Cancelar operação',
  'gitView.operation.state.unavailable': 'Status da operação indisponível',
  'gitView.operation.state.planned': 'Planejada',
  'gitView.operation.state.running': 'Em execução',
  'gitView.operation.state.succeeded': 'Concluída com sucesso',
  'gitView.operation.state.partial': 'Parcialmente concluída',
  'gitView.operation.state.failed': 'Falhou',
  'gitView.operation.state.cancelled': 'Cancelada',
  'gitView.operation.state.outcome-unknown': 'Resultado desconhecido',
  'gitView.operation.state.conflicted': 'Conflito',
  'gitView.operation.state.skipped': 'Ignorada',
  'gitView.operation.completed.validated': 'Repositório e destino validados',
  'gitView.operation.completed.authenticated': 'Autenticação concluída',
  'gitView.operation.completed.transferred': 'Transferência concluída',
  'gitView.operation.completed.updated-local-repository': 'Repositório local atualizado',
  'gitView.operation.completed.checked-out': 'Checkout concluído',
  'gitView.operation.completed.cleaned-up': 'Limpeza concluída',
  'gitView.remotes.title': 'Outros remotos',
  'gitView.remotes.description': 'Endereços que este repositório tem além daquele em que sua identidade foi aplicada. Enquanto um não for liberado, o OpenChamber não busca nem envia nada para ele.',
  'gitView.remotes.grant': 'Responder como {identity}',
  'gitView.hydration.title': 'Preparação do checkout',
  'gitView.hydration.description': 'Inicialize submódulos e baixe conteúdo do Git LFS com autorização separada para cada destino.',
  'gitView.hydration.parentRemote': 'Remoto principal',
  'gitView.hydration.retry': 'Tentar preparação novamente',
  'gitView.hydration.endpoint': 'Destino auxiliar',
  'gitView.hydration.identity': 'Identidade para este destino',
  'gitView.hydration.authorizationNeeded': 'A hidratação parou porque esses destinos ainda não têm identidade. Escolha uma para cada um e tente novamente.',
  'gitView.hydration.chooseEndpoint': 'Escolha um destino',
  'gitView.hydration.systemConfirmation': 'Permitir que o Git use credenciais do ambiente do sistema para este destino. O OpenChamber não pode verificar quais credenciais o Git usará.',
  'gitView.hydration.lfsMissing': 'O Git LFS não está instalado. Instale o git-lfs e tente a preparação novamente.',
  'gitView.hydration.kind.submodule': 'Submódulo',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Concluído',
  'gitView.hydration.status.failed': 'Falhou',
  'gitView.hydration.status.cancelled': 'Cancelado',
  'gitView.hydration.status.authorization-required': 'Autorização necessária',
  'gitView.hydration.status.invalid': 'Configuração inválida',
  'gitView.hydration.status.client-missing': 'Cliente ausente',
  'gitView.hydration.status.not-needed': 'Não necessário',
  'gitView.publish.title': 'Publicar',
  'gitView.publish.commitKept': 'O commit local foi criado e mantido. A publicação não foi concluída com sucesso.',
  'gitView.publish.syncTitle': 'Escolher destinos de sincronização',
  'gitView.publish.description': 'Publique {branch} em um destino Git exato. As contas do provedor não selecionam o destino.',
  'gitView.publish.fetchSource': 'Remoto de origem para busca',
  'gitView.publish.sourceBranch': 'Branch de origem',
  'gitView.publish.fetchFirst': 'Não há branches em cache para este remoto. Cancele e busque as alterações primeiro.',
  'gitView.publish.pushDestination': 'Remoto de destino para envio',
  'gitView.publish.selectRemote': 'Selecione um remoto vinculado',
  'gitView.publish.destinationBranch': 'Branch de destino',
  'gitView.publish.noGrants': 'Configure um vínculo de transporte Git antes de publicar.',
  'gitView.publish.contributorCommitFirst': 'Esta árvore de trabalho de colaborador exige aprovação do destino após o commit. Continuar? Cancelar a publicação depois manterá o commit local.',
  'gitView.publish.detached': 'A publicação com HEAD desanexado não é compatível. Faça checkout de uma branch local primeiro.',
  'gitView.publish.stale': 'A branch ou a autorização do Git mudou. Nenhuma nova tentativa foi feita. Escolha o destino novamente.',
  'gitView.publish.cancelled': 'Publicação cancelada. Nenhuma transferência Git foi iniciada.',
  'gitView.publish.succeeded': 'Publicado no destino selecionado',
  ...
  'chat.shellBoundary.status': 'Não verificado · fora do limite gerenciado',
  'chat.shellBoundary.agentAria': 'A execução de shell do agente não foi verificada e está fora do limite gerenciado do Git',
  'chat.shellBoundary.userAria': 'A execução de shell do usuário não foi verificada e está fora do limite gerenciado do Git',
  ...
  "worktree.bootstrap.toast.authorizationRequired": "Autorize o repositório do checkout e seus submódulos e tente novamente.",
  ...
  "gitView.pr.actions.openOnProvider": "Abrir no {provider}",
  "gitView.pr.actions.openOnProviderAria": "Abrir pull request no {provider}",
  ...
  "gitView.pr.providerNotConnected": "{provider} não está conectado",
  ...
  "gitView.pr.capabilitiesUnavailable": "Não foi possível carregar os recursos do provedor",
  ...
  'gitView.contributor.chooseDestination': 'Selecione o destino exato para este branch de colaborador.',
  'gitView.contributor.destination.contributor-fork': 'Fork do colaborador',
  'gitView.contributor.destination.own-fork': 'Seu fork',
  'gitView.contributor.destination.bound-repository': 'Repositório vinculado',
  'gitView.contributor.destination.other': 'Outro remoto',
  'gitView.toast.contributorPublishCancelled': 'A publicação foi cancelada. Nenhum remoto foi alterado.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'As alterações foram atualizadas localmente, mas a publicação foi cancelada.',
  "gitView.toast.unstageFileFailed": "Não foi possível remover as alterações do stage",
  "gitView.confirm.systemTransport": "O Git do sistema pode usar credenciais configuradas neste computador. Continuar com esta operação do Git?",
  ...
  "session.changeRequestPicker.error.noProvider": "Nenhum remoto de controle de código compatível foi encontrado",
  "session.changeRequestPicker.title": "Vincular solicitação de alteração",
  "session.changeRequestPicker.description": "Selecione um pull request ou merge request para anexar o contexto de revisão a esta mensagem.",
  "session.changeRequestPicker.searchPlaceholder": "Pesquise por título ou número, ou cole a URL de uma solicitação de alteração",
  "session.changeRequestPicker.includeDiffAria": "Incluir o diff da solicitação de alteração no contexto anexado",
  "session.changeRequestPicker.includeDiff": "Incluir diff",
  "session.changeRequestPicker.loading.changeRequests": "Carregando solicitações de alteração...",
  "session.changeRequestPicker.actions.useChangeRequest": "Usar solicitação de alteração {reference}",
  "session.changeRequestPicker.empty.noneFound": "Nenhuma solicitação de alteração encontrada",
  "session.changeRequestPicker.empty.noneOpen": "Nenhuma solicitação de alteração aberta encontrada",
  "session.issuePicker.title": "Vincular issue",
  "session.issuePicker.description": "Selecione uma issue para anexar o contexto dela a esta mensagem.",
  "session.issuePicker.searchPlaceholder": "Pesquise por título ou número, ou cole a URL de uma issue",
  "session.issuePicker.loading.issues": "Carregando issues...",
  "session.issuePicker.actions.useIssue": "Usar issue #{number}",
  "session.issuePicker.empty.noneFound": "Nenhuma issue encontrada",
  "session.issuePicker.empty.noneOpen": "Nenhuma issue aberta encontrada",
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'A autorização da solicitação de alteração não está mais disponível. Selecione-a novamente.',
  'session.newWorktree.trust.confirmation': 'Este checkout contém ações executáveis:\n\n{actions}\n\nExecutá-las agora? Cancelar deixa o checkout pronto para o Git sem executá-las.',
