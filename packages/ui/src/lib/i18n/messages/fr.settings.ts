...
export const settingsDict = {
  ...
  'settings.openchamber.visual.section.updates': 'Mises à jour',
  'settings.openchamber.visual.field.updateChannel': 'Canal de mise à jour',
  'settings.openchamber.visual.field.updateChannelHint': 'Choisissez Stable pour les versions officielles ou Beta pour les versions préliminaires',
  'settings.openchamber.visual.toast.switchedChannel': 'Canal de mise à jour changé pour {channel}.',
  'settings.openchamber.visual.toast.latestVersionForChannel': 'Vous utilisez la dernière version pour le canal {channel}.',
