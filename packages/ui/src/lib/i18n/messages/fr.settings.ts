...
export const settingsDict = {
  ...
  'settings.voice.page.localTts.availableToDownload': 'Disponibles au téléchargement',
  'settings.voice.page.localTts.filterPlaceholder': 'Filtrer par langue ou description',
  'settings.voice.page.localTts.filterNoMatch': 'Aucun modèle ne correspond au filtre',
