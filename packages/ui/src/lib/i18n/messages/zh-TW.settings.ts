...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.updateChannel': '更新通道',
  'settings.openchamber.visual.field.updateChannelHint': '選擇 Stable 獲取官方發行版本，選擇 Beta 獲取預發行版本',
  'settings.openchamber.visual.toast.switchedChannel': '更新通道已切換為 {channel}。',
  'settings.openchamber.visual.toast.latestVersionForChannel': '您正在使用 {channel} 通道的最新版本。',
