...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.voice.page.localTts.availableToDownload': '可下載',
  'settings.voice.page.localTts.filterPlaceholder': '依語言或描述篩選',
  'settings.voice.page.localTts.filterNoMatch': '沒有模型符合篩選條件',
