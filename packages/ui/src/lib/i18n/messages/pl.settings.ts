...
export const settingsDict = {
  ...
  'settings.openchamber.visual.section.updates': 'Aktualizacje',
  'settings.openchamber.visual.field.updateChannel': 'Kanał aktualizacji',
  'settings.openchamber.visual.field.updateChannelHint': 'Wybierz Stable dla oficjalnych wydań lub Beta dla wersji przedpremierowych',
  'settings.openchamber.visual.toast.switchedChannel': 'Zmieniono kanał aktualizacji na {channel}.',
  'settings.openchamber.visual.toast.latestVersionForChannel': 'Używasz najnowszej wersji dla kanału {channel}.',
