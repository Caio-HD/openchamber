...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.voice.page.localTts.availableToDownload': 'Dostępne do pobrania',
  'settings.voice.page.localTts.filterPlaceholder': 'Filtruj według języka lub opisu',
  'settings.voice.page.localTts.filterNoMatch': 'Żaden model nie pasuje do filtra',
