...
- A new workspace needs its manifest in the Dockerfile `deps` stage: the image installs from a pruned checkout, and a workspace something present depends on has to be there or the frozen install fails.
